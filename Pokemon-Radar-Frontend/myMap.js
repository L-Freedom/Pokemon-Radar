...
function loadMapScenario() {
    map_manager.map = new Microsoft.Maps.Map(document.getElementById('myMap'), {
        credentials: 'AoOBj5aR1WXSiiVwmrT8kpVJf3x7j-R4Hw1APIkI6pQLBTy0WJy5vZbq0cNULkpNAoOBj5aR1WXSiiVwmrT8kpVJf3x7j-R4Hw1APIkI6pQLBTy0WJy5vZbq0cNULkpN'
    });
    add_pokemon_layer();
}
...
function loadMapScenario(){
    map_manager.map = new Microsoft.Maps.Map(document.getElementById('myMap'),{
        credentials:'AoOBj5aR1WXSiiVwmrT8kpVJf3x7j-R4Hw1APIkI6pQLBTy0WJy5vZbq0cNULkpN'
    });
    add_pokemon_layer();
}
...
function get_pokemon_layer_from_map_items(map_items){
    ...
    for(var i in map_items){
        ...
        var pushpin = new Microsoft.Maps.Pushpin(
            new Microsoft.Maps.Location(map_item["latitude"], map_item["longitude"]),
            //new Microsoft.Maps.Location(34.4255028, -119.7007601),
            {
                icon: './images/pokemon/' + map_item["pokemon_id"] + '.png',
                title: get_counter_down_time_from_expire_epoch(map_item["expire"]),
            });
